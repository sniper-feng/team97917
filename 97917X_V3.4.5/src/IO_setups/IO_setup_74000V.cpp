...
// intake
vex::motor mtr_intake_L(vex::PORT8, vex::ratio36_1, true);
vex::motor mtr_intake_R(vex::PORT12,ratio36_1,false); 

// other
vex::motor mtr_swing(vex::PORT1, vex::ratio36_1, false);
vex::motor mtr_push(vex::PORT14, vex::ratio36_1, true);
...
#elif defined(bot_97917G)// bot_97917G
// move
vex::motor mtr_LF(vex::PORT18,ratio18_1, false);
...
vex::motor mtr_LF(vex::PORT18,ratio18_1, false);
vex::motor mtr_LB(vex::PORT4, ratio18_1,false);
vex::motor mtr_RF(vex::PORT3, ratio18_1,true);
vex::motor mtr_RB(vex::PORT2,ratio18_1, true);
